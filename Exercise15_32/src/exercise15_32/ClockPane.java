...
public class ClockPane extends Pane {
    ...
    private int minute;
    private int second;
    private boolean hourHandShown = true;
    private boolean minuteHandShown = true;
    private boolean secondHandShown = true;
    private Timeline timeline;

    // Panes width and height
    ...
    public boolean isHourHandShown() {
        return hourHandShown;
    }

    public void setHourHandShown(boolean hourHandShown) {
        this.hourHandShown = hourHandShown;
        paintClock();
    }

    public boolean isMinuteHandShown() {
        return minuteHandShown;
    }

    public void setMinuteHandShown(boolean minuteHandShown) {
        this.minuteHandShown = minuteHandShown;
        paintClock();
    }

    public boolean isSecondHandShown() {
        return secondHandShown;
    }

    public void setSecondHandShown(boolean secondHandShown) {
        this.secondHandShown = secondHandShown;
        paintClock();
    }
    ...
    private void paintClock() {
        ...
        sLine.setVisible(isSecondHandShown());
        ...
        mLine.setVisible(isMinuteHandShown());
        ...
        hLine.setVisible(isHourHandShown());
        // write time
